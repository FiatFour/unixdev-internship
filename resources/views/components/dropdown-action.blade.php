    ...
    <div class="col-sm-12">
        <div class="dropdown dropleft">
            <button type="button" class="btn-block-option"
                    ...
                    aria-expanded="false"
                    data-test="dropdownAction">
                <i class="fa fa-ellipsis-v"></i>
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdown-dropleft-dark">
                @if (isset($view_route))
                    <a class="dropdown-item" href="{{ $view_route }}" data-test="viewData"><i class="fa fa-eye me-1"></i> ดูข้อมูล</a>
                @endif
                @if (isset($edit_route))
                    <a class="dropdown-item" href="{{ $edit_route }}" data-test="edit"><i class="far fa-edit me-1"></i> แก้ไข</a>
                @endif
                ...
                @if (isset($delete_route))
                    <a class="dropdown-item btn-delete-row" href="javascript:void(0)"
                       data-route-delete="{{ $delete_route }}" data-test="delete"><i class="fa fa-trash-alt me-1"></i> ลบ</a>
                @endif
